 ...
 */
public class MultiPyramidModelTests {

  MultiPyramidSolitaire bps1;
  MultiPyramidSolitaire bps2;
  MultiPyramidSolitaire bps3;
  MultiPyramidSolitaire bps32;
  MultiPyramidSolitaire bps4;
  MultiPyramidSolitaire bps5;
  MultiPyramidSolitaire bps6;
  ...
  public void initConditions() {
    ...
    bps1 = new MultiPyramidSolitaire();

    bps2 = new MultiPyramidSolitaire();
    bps2.startGame(bps2.getDeck(), false, 2, 3);

    bps3 = new MultiPyramidSolitaire();
    bps3.startGame(bps3.getDeck(), false, 3, 4);

    bps4 = new MultiPyramidSolitaire();
    ...
    loc3d = Arrays.asList(h1, h2, h3, h4, h5, h6, h7, h8, h9, h10,
        h11, h12, h13, cl1, cl2, cl3, cl4, cl5, cl6, cl7, cl8, cl9, cl10, cl11,
        cl12, cl13, cb1, cb2, cb3, cb4, cb5, cb6, cb7, cb8,
        cb9, cb10, cb11, cb12, cb13, d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, d12, d13,
        ...
        cl12, cl13, cb1, cb2, cb3, cb4, cb5, cb6, cb7, cb8,
        cb9, cb10, cb11, cb12, cb13, d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, d12, d13);
    loc4 = Arrays.asList(h1, h2, h3, h12, h13, h8, h5, h6, h9, h10,
        h11, h4, h7, cl1, cl2, cl3, cl4, cl5, cl6, cl7, cl8, cl9, cl10, cl11,
        cl12, cl13, cb1, cb2, cb3, cb4, cb5, cb6, cb7, cb8,
        cb9, cb10, cb11, cb12, cb13, d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, d12, d13,
        h1, h2, h3, h4, h5, h6, h7, h8, h9, h10,
        h11, h12, h13, cl1, cl2, cl3, cl4, cl5, cl6, cl7, cl8, cl9, cl10, cl11,
    ...
    bps32 = new MultiPyramidSolitaire();

    bps5 = new MultiPyramidSolitaire();
    bps5.startGame(bps5.getDeck(), false, 8, 0);

    bps6 = new MultiPyramidSolitaire();
    ...
    ptv1 = new PyramidSolitaireTextualView(bps4);
  ...
  public void testGetCardAt() {
    assertEquals(cl2, bps4.getCardAt(1, 1));
  ...
  public void testGetScore() {
    assertEquals(388, bps4.getScore());
  }

  //return the correct score
  @Test
  public void testGetScore2() {
    assertEquals(24, bps3.getScore());
  }

  //returns the correct width (i.e. how many cards are in said row)
  @Test
  public void testGetRowWidth() {
    assertEquals(10, bps4.getRowWidth(3));
    assertEquals(3, bps3.getRowWidth(0));
    bps1.startGame(bps1.getDeck(), false, 7, 3);
    assertEquals(7, bps1.getRowWidth(0));
    assertEquals(19, bps1.getRowWidth(6));
  }
  ...
  //make sure you are able to remove to valid cards
  @Test
  public void testRemoveTwoCards() {
    bps6.remove(1, 2, 1, 3);
    assertEquals(null, bps6.getCardAt(1, 2));
    assertEquals(null, bps6.getCardAt(1, 3));
  }

  //make sure that you can't remove if one card is infront of the other
  @Test (expected = IllegalArgumentException.class)
  public void testRelaxedRemoveError() {
    bps6.remove(1, 1);
    bps6.remove(1, 0, 0, 0);
  ...
  public void testNumRows() {
    ...
    bps32.startGame(bps32.getDeck(), false, 7, 3);
    assertEquals(7, bps32.getNumRows());
  }
  ...
  public void testDiscardDraw() {
    bps4.discardDraw(0);
    assertEquals(cb4, bps4.getDrawCards().get(0));
  }
  ...
  //able to remove if the cards value is 13
  @Test
  ...
  public void testToString1() {
    MultiPyramidSolitaire ms = new MultiPyramidSolitaire();
    ms.startGame(ms.getDeck(), false, 2, 1);
    PyramidSolitaireView psv2 = new PyramidSolitaireTextualView(ms);

    assertEquals("  A♣  A♠  A♦\nA♥  2♣  2♠  2♦\nDraw: 2♥", psv2.toString());
  }
