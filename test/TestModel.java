...
public class TestModel {
  ...
  public void initConditions() {
    ...
    bps2 = new BasicPyramidSolitaire();
    bps2.startGame(bps2.getDeck(), false, 2, 3);

    bps3 = new BasicPyramidSolitaire();
    bps3.startGame(bps3.getDeck(), false, 3, 4);

    bps4 = new BasicPyramidSolitaire();
    ...
    bps32 = new BasicPyramidSolitaire();

    bps5 = new BasicPyramidSolitaire();
